...
vxc = megalib.vxc(auth.header, uid, b_uid, name, speed, mcr_v2_connect=True,
...
# vxc = megalib.vxc(auth.header, uid, b_uid, name, speed, mcr_v2_connect=True, ip=['192.168.0.0/31'])

# configure an IP & BGP
# vxc = megalib.vxc(auth.header, uid, b_uid, name, speed, mcr_v2_connect=True, ip=['192.168.1.0/31'],
